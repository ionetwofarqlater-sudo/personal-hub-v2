...
export function AccountBannedEmail({ userName, reason }: Props) {
  return (
    <Html>
      <Head />
      <Preview>Твій акаунт заблоковано</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={text}>
              Привіт, <strong>{userName || "друже"}</strong>. Твій акаунт було заблоковано
              адміністратором.
            </Text>
            {reason && (
